...
const EventPage = ({ currentUser, onLogout }) => {
  ...
  const event = {
    ...
    description:
      "Join us for an exciting evening of tech talks, networking, and innovation. Meet like-minded developers, entrepreneurs, and tech enthusiasts.",
    attendees: 156,
    mapImage:
      "https://images.pexels.com/photos/1366919/pexels-photo-1366919.jpeg?auto=compress&cs=tinysrgb&w=800&h=400&fit=crop",
  };
